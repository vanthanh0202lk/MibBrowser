...
public class BrowserFrame extends JFrame {
    ...
    private JTextArea sysLogArea = new JTextArea();
     ...
     */
    private MibWalkPanel mibWalkPanel = null;
    ...
    private void initialize() {
        ...
        mibWalkPanel = new MibWalkPanel(this);
    ...
    private void initializeMenu() {
        ...
        menu = new Menu("Functions");
        item = new MenuItem("Mib Browser...");
        item.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                verticalSplitPane.removeAll();
                verticalSplitPane.setDividerLocation((int) (bounds.height * 0.40));
                verticalSplitPane.setOneTouchExpandable(true);
                descriptionArea.setEditable(false);
                verticalSplitPane.setLeftComponent(new JScrollPane(descriptionArea));
        ...
        menu.add(item);
        item = new MenuItem("Convert Walk...");
        item.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                mibWalkPanel.setMibTree(mibTree);
                verticalSplitPane.removeAll();
                verticalSplitPane.setDividerLocation((int) (bounds.height * 0.40));
                verticalSplitPane.setOneTouchExpandable(true);
                descriptionArea.setEditable(false);
                verticalSplitPane.setLeftComponent(new JScrollPane(descriptionArea));
                verticalSplitPane.setRightComponent(mibWalkPanel);

               /* for (Map.Entry<String, String> entry : listMibOid.entrySet()) {
                    System.out.println(entry.getKey() + "/" + entry.getValue());
                    mibWalkPanel.appendResults("Oid Name: "+entry.getKey() + " oidID: " + entry.getValue()+"\n");
                }
    ...
    public Map<String, String> getlistMibOid(){
        return this.listMibOid;
    }
